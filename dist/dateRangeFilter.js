 ...
 */
export function applyDateRangeFilter(records, dateRange) {
    if (!dateRange)
        return [...records];
    log.warning(`dateRange="${dateRange}" was set, but this source publishes no per-record date field to filter on ` +
